...
sustainability goals. Our team consists of 17 talented students committed to making a difference. Are you ready to be a
part of us?
...
<Cards>
    ...
    <Card icon={<OneIcon/>} title="Full Stack Challenge" href="/challenges/fullstack"/>
    <Card icon={<OneIcon/>} title="RAG Challenge" href="/challenges/rag"/>
</Cards>