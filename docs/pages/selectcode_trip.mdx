...
exclusive SelectCode Challenge, where you'll have the opportunity to showcase your skills and join us on the
SelectCode Trip! 🎉

## What are the requirements for taking part? 📝

- 🧑‍💻👩‍💻 You are studying Computer Science, Information Systems or something similar in Munich or the surrounding area.
- 💬 Your German level at least C1.
- 🔥 You are a team player and have a passion for software development.
- 📅 You are still free between September 4 and September 6.

## What is the SelectCode trip? 🏄‍

The SelectCode Trip is our highlight of the year - three days with our team at the nicest AirBnb in Austria! 🇦🇹

This year, it will take place between September 4 and September 6! 📅

During these three days you can expect an exciting program: - with interactive workshops 🔥, hikes 🚶, table
tennis 🏓 / table soccer ⚽ / Xbox tournaments 🎮 or just a relaxed time together in the evening 😌
...
<Steps>
    ...
    Register for the SelectCode Challenge using this [online form](https://tally.so/r/wveMKv).
    This is useful for us to contact you as soon as we have any major announcements for everyone or updates of the
    challenges. 💬

    Access the challenge instructions and solve the three fullstack tasks before August 24.
    Don't forget to submit your solutions via our [online form](https://tally.so/r/w5jbp6). 📋
    ...
    selection process will take place on August 25. 📋
