...
If you're up for the challenge and ready to embark on an exciting journey with our team, don't miss this
opportunity!
Take the first step by solving the challenges and submitting your solutions before the deadline.

If you have any questions or need assistance, feel free to start a new discussion
[here](https://github.com/SelectCode/apply/discussions). 📧

Also check out our [FAQ](/faq) for more information, we will keep them updated with all the questions we get.
